...
func (client *ClientImpl) AddBuildTag(ctx context.Context, args AddBuildTagArgs) (*[]string, error) {
	...
	resp, err := client.Client.Send(ctx, http.MethodPut, locationId, "6.0", routeValues, nil, nil, "", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) AddDefinitionTag(ctx context.Context, args AddDefinitionTagArgs) (*[]string, error) {
	...
	resp, err := client.Client.Send(ctx, http.MethodPut, locationId, "6.0-preview.2", routeValues, nil, nil, "", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) CreateFolder(ctx context.Context, args CreateFolderArgs) (*Folder, error) {
	...
	resp, err := client.Client.Send(ctx, http.MethodPut, locationId, "6.0-preview.2", routeValues, queryParams, bytes.NewReader(body), "application/json", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) DeleteDefinitionTag(ctx context.Context, args DeleteDefinitionTagArgs) (*[]string, error) {
	...
	locationId, _ := uuid.Parse("cb894432-134a-4d31-a839-83beceaace4b")
	resp, err := client.Client.Send(ctx, http.MethodDelete, locationId, "6.0-preview.2", routeValues, nil, nil, "", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) GetAttachment(ctx context.Context, args GetAttachmentArgs) (io.ReadCloser, error) {
	...
	resp, err := client.Client.Send(ctx, http.MethodGet, locationId, "6.0-preview.2", routeValues, nil, nil, "", "application/octet-stream", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) GetBuildReportHtmlContent(ctx context.Context, args GetBuildReportHtmlContentArgs) (io.ReadCloser, error) {
	...
	locationId, _ := uuid.Parse("45bcaa88-67e1-4042-a035-56d3b4a7d44c")
	resp, err := client.Client.Send(ctx, http.MethodGet, locationId, "6.0-preview.2", routeValues, queryParams, nil, "", "text/html", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) RestoreDefinition(ctx context.Context, args RestoreDefinitionArgs) (*BuildDefinition, error) {
	...
	locationId, _ := uuid.Parse("dbeaf647-6167-421a-bda9-c9327b25e2e6")
	resp, err := client.Client.Send(ctx, http.MethodPatch, locationId, "6.0", routeValues, queryParams, nil, "", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) RestoreWebhooks(ctx context.Context, args RestoreWebhooksArgs) error {
	...
	_, err := client.Client.Send(ctx, http.MethodPost, locationId, "6.0-preview.1", routeValues, queryParams, bytes.NewReader(body), "application/json", "application/json", nil)
	if err != nil {
		return err
	}
...
func (client *ClientImpl) UpdateDefinition(ctx context.Context, args UpdateDefinitionArgs) (*BuildDefinition, error) {
	...
	locationId, _ := uuid.Parse("dbeaf647-6167-421a-bda9-c9327b25e2e6")
	resp, err := client.Client.Send(ctx, http.MethodPut, locationId, "6.0", routeValues, queryParams, bytes.NewReader(body), "application/json", "application/json", nil)
	if err != nil {
		return nil, err
	}
