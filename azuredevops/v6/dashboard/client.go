...
func (client *ClientImpl) GetWidgets(ctx context.Context, args GetWidgetsArgs) (*WidgetsVersionedList, error) {
	...
	locationId, _ := uuid.Parse("bdcff53a-8355-4172-a00a-40497ea23afc")
	resp, err := client.Client.Send(ctx, http.MethodGet, locationId, "6.0-preview.2", routeValues, nil, nil, "", "application/json", additionalHeaders)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) ReplaceDashboard(ctx context.Context, args ReplaceDashboardArgs) (*Dashboard, error) {
	...
	locationId, _ := uuid.Parse("454b3e51-2e6e-48d4-ad81-978154089351")
	resp, err := client.Client.Send(ctx, http.MethodPut, locationId, "6.0-preview.3", routeValues, nil, bytes.NewReader(body), "application/json", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) ReplaceWidgets(ctx context.Context, args ReplaceWidgetsArgs) (*WidgetsVersionedList, error) {
	...
	locationId, _ := uuid.Parse("bdcff53a-8355-4172-a00a-40497ea23afc")
	resp, err := client.Client.Send(ctx, http.MethodPut, locationId, "6.0-preview.2", routeValues, nil, bytes.NewReader(body), "application/json", "application/json", additionalHeaders)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) UpdateWidgets(ctx context.Context, args UpdateWidgetsArgs) (*WidgetsVersionedList, error) {
	...
	locationId, _ := uuid.Parse("bdcff53a-8355-4172-a00a-40497ea23afc")
	resp, err := client.Client.Send(ctx, http.MethodPatch, locationId, "6.0-preview.2", routeValues, nil, bytes.NewReader(body), "application/json", "application/json", additionalHeaders)
	if err != nil {
		return nil, err
	}
