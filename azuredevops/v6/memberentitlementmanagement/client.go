...
import (
	...
	"github.com/MarcoDelGamba/azure-devops-go-api/azuredevops/v6/licensingrule"
...
func (client *ClientImpl) AddMemberToGroup(ctx context.Context, args AddMemberToGroupArgs) error {
	...
	_, err := client.Client.Send(ctx, http.MethodPut, locationId, "6.0-preview.1", routeValues, nil, nil, "", "application/json", nil)
	if err != nil {
		return err
	}
...
func (client *ClientImpl) AddUserEntitlement(ctx context.Context, args AddUserEntitlementArgs) (*UserEntitlementsPostResponse, error) {
	...
	resp, err := client.Client.Send(ctx, http.MethodPost, locationId, "6.0-preview.3", nil, nil, bytes.NewReader(body), "application/json", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) GetUserEntitlement(ctx context.Context, args GetUserEntitlementArgs) (*UserEntitlement, error) {
	...
	locationId, _ := uuid.Parse("8480c6eb-ce60-47e9-88df-eca3c801638b")
	resp, err := client.Client.Send(ctx, http.MethodGet, locationId, "6.0-preview.3", routeValues, nil, nil, "", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) SearchUserEntitlements(ctx context.Context, args SearchUserEntitlementsArgs) (*PagedGraphMemberList, error) {
	...
	locationId, _ := uuid.Parse("387f832c-dbf2-4643-88e9-c1aa94dbb737")
	resp, err := client.Client.Send(ctx, http.MethodGet, locationId, "6.0-preview.3", nil, queryParams, nil, "", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) UpdateGroupEntitlement(ctx context.Context, args UpdateGroupEntitlementArgs) (*GroupEntitlementOperationReference, error) {
	...
	locationId, _ := uuid.Parse("2280bffa-58a2-49da-822e-0764a1bb44f7")
	resp, err := client.Client.Send(ctx, http.MethodPatch, locationId, "6.0-preview.1", routeValues, queryParams, bytes.NewReader(body), "application/json-patch+json", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) UpdateUserEntitlement(ctx context.Context, args UpdateUserEntitlementArgs) (*UserEntitlementsPatchResponse, error) {
	...
	locationId, _ := uuid.Parse("8480c6eb-ce60-47e9-88df-eca3c801638b")
	resp, err := client.Client.Send(ctx, http.MethodPatch, locationId, "6.0-preview.3", routeValues, nil, bytes.NewReader(body), "application/json-patch+json", "application/json", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) UpdateUserEntitlements(ctx context.Context, args UpdateUserEntitlementsArgs) (*UserEntitlementOperationReference, error) {
	...
	locationId, _ := uuid.Parse("387f832c-dbf2-4643-88e9-c1aa94dbb737")
	resp, err := client.Client.Send(ctx, http.MethodPatch, locationId, "6.0-preview.3", nil, queryParams, bytes.NewReader(body), "application/json-patch+json", "application/json", nil)
	if err != nil {
		return nil, err
	}
