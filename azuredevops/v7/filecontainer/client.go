...
func (client *ClientImpl) GetItems(ctx context.Context, args GetItemsArgs) (*[]FileContainerItem, error) {
	...
	if args.IgnoreRequestedMediaType != nil {
		queryParams.Add("ignoreRequestedMediaType", strconv.FormatBool(*args.IgnoreRequestedMediaType))
	}
	if args.IncludeBlobMetadata != nil {
		queryParams.Add("includeBlobMetadata", strconv.FormatBool(*args.IncludeBlobMetadata))
	}
	if args.SaveAbsolutePath != nil {
		queryParams.Add("saveAbsolutePath", strconv.FormatBool(*args.SaveAbsolutePath))
	}
	locationId, _ := uuid.Parse("e4f5c81e-e250-447b-9fef-bd48471bea5e")
...
type GetItemsArgs struct {
	...
	IsShallow *bool
	// (optional)
	IgnoreRequestedMediaType *bool
	// (optional)
	IncludeBlobMetadata *bool
	// (optional)
	SaveAbsolutePath *bool
}
