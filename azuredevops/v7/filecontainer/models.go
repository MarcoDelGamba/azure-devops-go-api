...
type BlobCompressionType string

type blobCompressionTypeValuesType struct {
	None BlobCompressionType
	GZip BlobCompressionType
}

var BlobCompressionTypeValues = blobCompressionTypeValuesType{
	None: "none",
	GZip: "gZip",
}

// Represents an reference to a file in Blobstore
type ContainerItemBlobReference struct {
	ArtifactHash    *string              `json:"artifactHash,omitempty"`
	ArtifactId      *uint64              `json:"artifactId,omitempty"`
	CompressionType *BlobCompressionType `json:"compressionType,omitempty"`
...
type FileContainerItem struct {
	...
	ArtifactId   *uint64                     `json:"artifactId,omitempty"`
	BlobMetadata *ContainerItemBlobReference `json:"blobMetadata,omitempty"`
	// Container Id.
