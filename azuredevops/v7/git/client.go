...
import (
	...
	"github.com/MarcoDelGamba/azure-devops-go-api/azuredevops/v7/policy"
...
func (client *ClientImpl) GetAttachmentZip(ctx context.Context, args GetAttachmentZipArgs) (io.ReadCloser, error) {
	...
	locationId, _ := uuid.Parse("965d9361-878b-413b-a494-45d5b5fd8ab7")
	resp, err := client.Client.Send(ctx, http.MethodGet, locationId, "7.1-preview.1", routeValues, nil, nil, "", "application/zip", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) GetBlobsZip(ctx context.Context, args GetBlobsZipArgs) (io.ReadCloser, error) {
	...
	locationId, _ := uuid.Parse("7b28e929-2c99-405d-9c5c-6167a06e6816")
	resp, err := client.Client.Send(ctx, http.MethodPost, locationId, "7.1-preview.1", routeValues, queryParams, bytes.NewReader(body), "application/json", "application/zip", nil)
	if err != nil {
		return nil, err
	}
...
func (client *ClientImpl) GetCommits(ctx context.Context, args GetCommitsArgs) (*[]GitCommitRef, error) {
	...
	if args.SearchCriteria.ShowOldestCommitsFirst != nil {
		queryParams.Add("searchCriteria.showOldestCommitsFirst", strconv.FormatBool(*args.SearchCriteria.ShowOldestCommitsFirst))
	}
	if args.Skip != nil {
		queryParams.Add("$skip", strconv.Itoa(*args.Skip))
	}
...
func (client *ClientImpl) GetItem(ctx context.Context, args GetItemArgs) (*GitItem, error) {
	...
	if args.Sanitize != nil {
		queryParams.Add("sanitize", strconv.FormatBool(*args.Sanitize))
	}
...
func (client *ClientImpl) GetItems(ctx context.Context, args GetItemsArgs) (*[]GitItem, error) {
	...
	if args.ZipForUnix != nil {
		queryParams.Add("zipForUnix", strconv.FormatBool(*args.ZipForUnix))
	}
	locationId, _ := uuid.Parse("fb93c0db-47ed-4a31-8c20-47552878fb44")
	resp, err := client.Client.Send(ctx, http.MethodGet, locationId, "7.1-preview.1", routeValues, queryParams, nil, "", "application/json", nil)
	if err != nil {
...
func (client *ClientImpl) GetPermission(ctx context.Context, args GetPermissionArgs) (*bool, error) {
	...
	if args.ProjectName != nil {
		queryParams.Add("$projectName", *args.ProjectName)
	}
	if args.RepositoryId != nil {
		queryParams.Add("$repositoryId", *args.RepositoryId)
	}
	if args.Permission != nil {
		queryParams.Add("$permission", *args.Permission)
	}
	locationId, _ := uuid.Parse("61b21a05-a60f-4910-a733-ba5347c2142d")
