...
type DefaultAccessLevel string

type defaultAccessLevelValuesType struct {
	Stakeholder DefaultAccessLevel
	Basic       DefaultAccessLevel
}

var DefaultAccessLevelValues = defaultAccessLevelValuesType{
...
type SubscriptionSpendingLimit string

type subscriptionSpendingLimitValuesType struct {
	On               SubscriptionSpendingLimit
	Off              SubscriptionSpendingLimit
	CurrentPeriodOff SubscriptionSpendingLimit
}

var SubscriptionSpendingLimitValues = subscriptionSpendingLimitValuesType{
