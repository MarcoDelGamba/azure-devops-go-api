...
type Client interface {
	...
	GetDebugEntryContent(context.Context, GetDebugEntryContentArgs) error
...
func (client *ClientImpl) GetDebugEntryContent(ctx context.Context, args GetDebugEntryContentArgs) error {
	...
	routeValues["requestId"] = *args.RequestId
	if args.DebugEntryId == nil || *args.DebugEntryId == "" {
		return &azuredevops.ArgumentNilOrEmptyError{ArgumentName: "args.DebugEntryId"}
	}
	routeValues["debugEntryId"] = *args.DebugEntryId

	locationId, _ := uuid.Parse("0f98d9f5-caf7-44fd-a5c9-55f3a9b34399")
	_, err := client.Client.Send(ctx, http.MethodGet, locationId, "7.1-preview.1", routeValues, nil, nil, "", "application/json", nil)
	if err != nil {
		return err
	}
...
type GetDebugEntryContentArgs struct {
	// (required) The symbol request identifier.
	RequestId *string
	// (required) The debug entry identifier.
	DebugEntryId *string
}
...
func (client *ClientImpl) HeadClient(ctx context.Context, args HeadClientArgs) error {
	locationId, _ := uuid.Parse("79c83865-4de3-460c-8a16-01be238e0818")
	_, err := client.Client.Send(ctx, http.MethodHead, locationId, "7.1-preview.1", nil, nil, nil, "", "application/json", nil)
	if err != nil {
		return err
	}
...
func (client *ClientImpl) CheckAvailability(ctx context.Context, args CheckAvailabilityArgs) error {
	...
	_, err := client.Client.Send(ctx, http.MethodGet, locationId, "7.1-preview.1", nil, nil, nil, "", "application/json", nil)
	if err != nil {
		return err
	}
...
func (client *ClientImpl) UpdateRequestsRequestName(ctx context.Context, args UpdateRequestsRequestNameArgs) (*Request, error) {
	...
	locationId, _ := uuid.Parse("ebc09fe3-1b20-4667-abc5-f2b60fe8de52")
	resp, err := client.Client.Send(ctx, http.MethodPatch, locationId, "7.1-preview.1", nil, queryParams, bytes.NewReader(body), "application/json", "application/json", nil)
	if err != nil {
		return nil, err
	}
